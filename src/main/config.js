...
const pullTabPricing = [
        {
            ...
            sku: 173020,
            price: 1.49,
            description: 'Loop Pull Tab - Clear'
        },
        {
            label: 'Pull Tab - Plastic - Black (358671)',
            sku: 358671,
            price: 0.59,
            description: 'Pull Tab - Plastic - Black'
        }
]
...
const screenClips = [
    {
        ...
        sku: 267908,
        price: 0.99,
        description: 'Screen Clip - 1/16"'
    },
    {
        label: 'Screen Clip - 3/16" - (176633)',
        sku: 176633,
        price: 0.99,
        description: 'Screen Clip - 3/16"'
    },
    {
        label: 'Screen Clip - 5/16" - (268101)',
        sku: 268101,
        price: 0.99,
        description: 'Screen Clip - 5/16"'
    },
    {
        label: 'Screen Clip - 7/16" - (268208)',
        sku: 268208,
        price: 0.99,
        description: 'Screen Clip - 7/16"'
    }
]

const hawaiiTaxRate = 0.045;
  
export { elementSKUs, sizePrices, screenPricing, splinePricing, spreaderBarPricing, pullTabPricing, springPricing, spreaderBarClip, clipSpring, screenClips, hawaiiTaxRate };
